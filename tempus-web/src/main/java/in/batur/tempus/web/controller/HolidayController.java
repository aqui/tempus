...
public class HolidayController 
{
	...
	@GetMapping(path = "/{id}")
	public Holiday getRoleById(@PathVariable Long id) 
	{
	...
	@PostMapping
	public Holiday saveRole(@Valid @RequestBody Holiday holiday) 
	{
		return holidayService.saveHoliday(holiday);
	}
	
	@PutMapping
	public void updateRole(@Valid @RequestBody Holiday holiday) 
	{
